                    ...
                    children: [
                      Expanded(
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            color: Colors.blue[
                                100], // Color celeste para el fondo del marco
  ...
  child: Container(
    color: Colors.white, // Color blanco
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        color: Colors
                            .blue[100], // Color celeste para el fondo del marco
                        borderRadius: BorderRadius.circular(10.0),
                      ),
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
              ...
              Container(
                ...
                child: ElevatedButton(
                  ...
                  style: ElevatedButton.styleFrom(
                    padding: EdgeInsets
                        .zero, // Eliminar el relleno interno del botón
                    backgroundColor: Color.fromARGB(255, 61, 192, 76),
                    shape: RoundedRectangleBorder(
                      borderRadius: BorderRadius.circular(
                          20.0), // Radio de borde personalizado
                    ),
                  ),
                  child: Ink(
                    decoration: BoxDecoration(
